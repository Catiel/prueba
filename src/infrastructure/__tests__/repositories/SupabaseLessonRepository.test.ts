...
describe('SupabaseLessonRepository', () => {
  ...
  describe('createLesson', () => {
    it('should create a new lesson', async () => {
      ...
      mockSupabase.single.mockResolvedValue({ data: mockCreatedLesson, error: null });
    ...
    it('should throw error when creation fails', async () => {
      ...
      await expect(repository.createLesson({
        module_id: 'module-1',
        title: 'New Lesson',
        content: 'Content',
        order_index: 1,
  ...
  describe('updateLesson', () => {
    it('should update lesson', async () => {
      ...
      mockSupabase.single.mockResolvedValue({ data: mockUpdatedLesson, error: null });
  ...
  describe('deleteLesson', () => {
    ...
    it('should throw error when delete fails', async () => {
      ...
      await expect(repository.deleteLesson('lesson-1')).rejects.toThrow('Error al eliminar lección');
    });
  });
});
