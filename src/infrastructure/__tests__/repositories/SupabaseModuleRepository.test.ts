...
describe('SupabaseModuleRepository', () => {
  ...
  describe('createModule', () => {
    it('should create a new module', async () => {
      ...
      mockSupabase.single.mockResolvedValue({ data: mockCreatedModule, error: null });
    ...
    it('should throw error when creation fails', async () => {
      ...
      await expect(repository.createModule({
        course_id: 'course-1',
        title: 'New Module',
        order_index: 1,
  ...
  describe('updateModule', () => {
    it('should update module', async () => {
      ...
      mockSupabase.single.mockResolvedValue({ data: mockUpdatedModule, error: null });
  ...
  describe('deleteModule', () => {
    ...
    it('should throw error when delete fails', async () => {
      ...
      await expect(repository.deleteModule('module-1')).rejects.toThrow('Error al eliminar módulo');
    });
  });
});
