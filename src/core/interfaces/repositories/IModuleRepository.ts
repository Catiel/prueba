...
export interface IModuleRepository {
  ...
  createModule(data: Omit<CourseModuleData, 'id' | 'created_at' | 'updated_at'>): Promise<CourseModuleEntity>;
  updateModule(id: string, data: Partial<CourseModuleData>): Promise<CourseModuleEntity>;
