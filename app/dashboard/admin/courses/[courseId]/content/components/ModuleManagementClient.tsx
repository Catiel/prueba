...
export function ModuleManagementClient({ courseId, modules, isAdmin }: ModuleManagementClientProps) {
      ...
      {sortedModules.length === 0 ? (
        ...
        <div className="space-y-4">
          {sortedModules.map((module) => (
            <Card key={module.id} className="border-2 transition-shadow hover:shadow-lg">
              <CardHeader>
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-shrink-0 gap-2">
                    <Link href={`/dashboard/admin/courses/${courseId}/modules/${module.id}/lessons`}>
