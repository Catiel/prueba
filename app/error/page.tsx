...
type ErrorType = "auth_failed" | "otp_verification_failed" | "invalid_auth_params" | "unexpected_error";

export default function ErrorPage({ searchParams }: ErrorPageProps): JSX.Element {
  const errorType: ErrorType | undefined = searchParams.error as ErrorType | undefined;
    ...
    switch (errorType) {
      case "auth_failed":
        return {
          ...
          description: "No se pudo completar el proceso de autenticación con Google. Por favor, intenta de nuevo.",
          suggestion: "Verifica que tu cuenta de Google esté configurada correctamente."
        };
      ...
      case "unexpected_error":
        return {
          ...
          suggestion: "Por favor, intenta de nuevo. Si el problema persiste, contacta con soporte."
        };
      default:
        return {
